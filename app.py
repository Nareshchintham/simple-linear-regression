...
model = pickle.load(open(r'D:\FULL STACK DATA SCIENCE\MACHINE LEARNING FULL NOTES\13th - slr with streamlit (1)\13th - slr with streamlit\linear_regression_model.pkl', 'rb'))
